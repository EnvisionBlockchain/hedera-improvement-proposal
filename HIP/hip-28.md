...
Introduce a recommended path of the implementation for minting and maintenance of ecological tokens based on IWA sustainability specifications from the voluntary ecological markets taskforce. This combines and is the first use-case of Dynamic Non-Fungible / Fungible Tokens (dNFT/dFT) on hedera to provide an ability for tokens to attach an unlimited amount of evidence.
